...
def build_command_registry(bot_app) -> List[Dict[str, object]]:
    commands = [
        ...
        },
        {
            ...
            "desc_key": "cmd.sessions_search.desc",
            "desc": "Поиск сессий по подстроке в имени, ID или рабочей директории.",
            "handler": bot_app.cmd_sessions_search,
            "menu": False,
        },
        {
            "name": "git_branch",
            "desc_key": "cmd.git_branch.desc",
            "desc": "Создать ветку git.",
            "handler": bot_app.cmd_git_branch,
            "menu": False,
        },
        {
            "name": "git_checkout",
            "desc_key": "cmd.git_checkout.desc",
            "desc": "Переключиться на ветку git.",
            "handler": bot_app.cmd_git_checkout,
            "menu": False,
        },
        {
            "name": "git_stash_pop",
            "desc_key": "cmd.git_stash_pop.desc",
            "desc": "Применить последний git stash pop.",
            "handler": bot_app.cmd_git_stash_pop,
            "menu": False,
        },
        {
            "name": "git_show",
            "desc_key": "cmd.git_show.desc",
            "desc": "Показать diff коммита (по умолчанию HEAD).",
            "handler": bot_app.cmd_git_show,
            "menu": False,
        },
        {
            "name": "remote_git_pull",
            "desc_key": "cmd.remote_git_pull.desc",
            "desc": "Git pull на удалённом SSH-хосте.",
            "handler": bot_app.cmd_remote_git_pull,
            "menu": False,
            "admin_only": True,
        },
        {
            "name": "remote_git_push",
            "desc_key": "cmd.remote_git_push.desc",
            "desc": "Git push на удалённом SSH-хосте.",
            "handler": bot_app.cmd_remote_git_push,
            "menu": False,
            "admin_only": True,
        },
        {
            "name": "remote_git_fetch",
            "desc_key": "cmd.remote_git_fetch.desc",
            "desc": "Git fetch на удалённом SSH-хосте.",
            "handler": bot_app.cmd_remote_git_fetch,
            "menu": False,
            "admin_only": True,
        },
    ]
