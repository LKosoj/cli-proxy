...
- `defaults.manager_*`: настройки режима Manager — лимит задач, попыток, таймауты декомпозиции/разработки/ревью, обрезка отчётов, автовозобновление плана, debug‑логирование в `.manager/`
