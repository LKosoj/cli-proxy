...
- Отчёты текущей сессии доступны в Telegram через `/reports`; финальный отчёт Manager автоматически сохраняется в общую историю отчётов.
...
4. **Работа с результатом**
   ...
   - Отчёты сессии смотрите через `/reports`; `/reports latest` отправляет последний отчёт, `/reports generate` создаёт отчёт из текущего Manager-плана, `/reports <filename.md>` отправляет конкретный файл.
...
- `/reports` - показать, создать или отправить отчёты текущей сессии (`latest`, `generate`, `<filename.md>`)
