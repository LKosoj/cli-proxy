...
- Не добавляй шаги вида "сформировать итоговый ответ пользователю"/"написать финальный ответ": финальный user-facing ответ формирует сам оркестратор отдельным шагом после выполнения плана.
