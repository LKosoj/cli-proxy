...
def adapt_validated_settings(settings: ValidatedSettings, *, path: str) -> "AppConfig":
    ...
    tools = {
        name: ToolConfig(
            ...
            execution_backends=list(tool.execution_backends) if tool.execution_backends else None,
            default_execution_backend=tool.default_execution_backend,
            tmux_user=tool.tmux_user,
            ...
            interactive_resume_cmd=list(tool.interactive_resume_cmd) if tool.interactive_resume_cmd else None,
    ...
    defaults = DefaultsConfig(
        ...
        default_execution_backend=settings.defaults.default_execution_backend,
