...
- Inline Git menu (status/fetch/pull ff-only/merge/rebase/diff/log/stash) for the active session.
...
- `/git` — Git actions for the active session (inline menu: status/fetch/pull/merge/rebase/diff/log/stash)
