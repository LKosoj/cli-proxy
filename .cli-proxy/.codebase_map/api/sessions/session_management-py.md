...
- `async def recover_tmux_sessions(context)` (line 283)
- `async def reread_tmux_output(session, context)` (line 286)
- `async def run_mode_pipeline(session, prompt, dest, context)` (line 289)
